...
urlpatterns = [
    ...
    path('get_verified_details/', views.get_verified_details, name="get_verified_details"),
    path('get_payment_details/', views.get_payment_details, name="get_payment_details"),
